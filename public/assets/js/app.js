 ...
 *
 * EN: Controls mobile navigation, AJAX forms, file uploads, and user feedback.
 * RU: Управляет мобильной навигацией, AJAX-формами, загрузками файлов и обратной связью.
 */
...
(function ($) {
    ...
    $(function () {
        ...
        $('.js-ajax-form').on('submit', function (event) {
            ...
            var payload = hasFile ? new FormData(this) : $form.serialize();
            var ajaxOptions = {
